...
public class CertAnalysisRouting {
    private static final Logger log =
            org.apache.logging.log4j.LogManager.getLogger(CertAnalysisRouting.class);
...
//        BaseAnalyzer.analyzeSliceInternal(criteriaClass, classNames, endPoint, slicingParameters, checker);
        CertAnalyzer.analyzeiceInternal(criteriaClass,classNames,endPoint,slicingParameters,checker);
