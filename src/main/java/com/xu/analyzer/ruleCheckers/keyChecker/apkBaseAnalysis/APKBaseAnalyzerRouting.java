...
import static com.xu.utils.Utils.getJwtContainClassName;

public class APKBaseAnalyzerRouting {
        private static final Logger log =
                org.apache.logging.log4j.LogManager.getLogger(APKBaseAnalyzerRouting.class);
...
/*                SootClass sc = Scene.v().getSootClass(clazz);
            ...
            if (jwtContainClass != null && !jwtContainClass.isEmpty()) {
                ...
                for (String clazz : classNames) {
                    if(clazz.contains("kotlin") || clazz.contains("okhttp3") || clazz.contains("androidx")){
                        continue;
                    }
...
/*        BaseAnalyzer.analyzeSliceInternal2(
            ...
            ApkBaseAnalyzer.analyzeSliceInternal(criteriaClass, newClasses, endPoint, slicingParameters, checker);
        }
