...
public abstract class ConstantKeyFinder extends BaseRuleChecker {
    private static final Logger log =
            org.apache.logging.log4j.LogManager.getLogger(ConstantKeyFinder.class);
    ...
    public void createAnalysisOutput(
        ...
        Utils.createAnalysisOutput(xmlFileStr, sourcePaths, predictableSourcMap, rule, output,getLibName());
